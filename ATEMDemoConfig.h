...
/*********************/
 ...
 #define LOG_THREAD_PRIO             ((EC_T_DWORD)4)     /* EtherCAT message logging thread priority */
 #define MAIN_THREAD_PRIO            ((EC_T_DWORD)10)
 #define DEMO_PARAMETERS             "-XMC 1 1 -v 3 -t 60000 -auxclk 1000"
 #define LOG_THREAD_STACKSIZE		 0x2000
...
#define DEMO_PARAMETERS             "-v 2 -fslfec 1 1 imxceetul2 -perf -f sdcard:0:\\eni.xml"
...
#else
#define MASTER_CFG_MAX_SENT_QUFRM_PER_CYC      6    /* max number of queued frames sent with eUsrJob_SendAcycFrames within one cycle */
#endif
