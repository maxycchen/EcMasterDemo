...
#define DEFAULT_ERR_MSG_BUFFER_SIZE    0 /* number of buffered messages */
...
/*-GLOBAL VARIABLES-----------------------------------------------------------*/
    ...
    || (defined EC_VERSION_JSLWARE) || (defined EC_VERSION_UCOS) || (defined EC_VERSION_XMC)
...
#if (DEFAULT_ERR_MSG_BUFFER_SIZE > 0)
