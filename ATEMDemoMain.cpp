...
#define STATIC_MASTERENI_XML_DATA_SIZE     (size_t)((EC_T_VOID*)MasterENI_xml_data_size)
    ...
    (defined EC_VERSION_RZGNOOS) || (defined EC_VERSION_JSLWARE) || (defined EC_VERSION_XMC)
...
#define STATIC_MASTERENI_XML_DATA_SIZE     MasterENI_xml_data_size
    ...
    (defined EC_VERSION_JSLWARE) || ((defined EC_VERSION_QNX) && (EC_VERSION_QNX >= 700)) || (defined EC_VERSION_XMC)
...
EC_T_CPUSET       CpuSet;
    ...
    if(procmgr_ability(0,
       			...
       			PROCMGR_AID_EOL) != 0)
   	{
   		OsPrintf("procmgr_ability PROCMGR_AID_CLOCKPERIOD failed\n");
   	}
...
#endif
{
    ...
    (defined EC_VERSION_UCOS) || (defined EC_VERSION_XMC)
...
/*-Handle static linked link layers -----------------------------------------*/
    ...
    || (defined EC_VERSION_UCOS) || (defined EC_VERSION_ECOS) || (defined EC_VERSION_XMC)
#ifdef __cplusplus
extern "C"
{
#endif /* __cplusplus */
...
extern EC_T_DWORD emllRegisterAntaios (EC_T_LINK_DRV_DESC* pLinkDrvDesc, EC_T_DWORD dwLinkDrvDescSize);
extern EC_T_DWORD emllRegisterXMC    (EC_T_LINK_DRV_DESC* pLinkDrvDesc, EC_T_DWORD dwLinkDrvDescSize);
...
#endif
#if (defined LINKLAYER_XMC)
    if (0 == OsStrcmp(EC_LINK_PARMS_IDENT_XMC, szDriverIdent))
    {
        pfLlRegister = (EC_PF_LLREGISTER)emllRegisterXMC;
    } else
#endif
    {
